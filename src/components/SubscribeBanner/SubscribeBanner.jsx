...
function SubscribeBanner() {
  return (
    <div className="mt-20 md:flex justify-center h-fit md:w-full w-screen mb-10">
        <div className='h-fit w-fit md:w-full rounded-xl bg-gradient-to-r from-white to-red-200 md:mx-32 py-20 text-center flex flex-col items-center justify-center'>
