    ...
    <div className='flex md:justify-around items-center border p-2 shadow-sm'>
        ...
        <div>
            <ul className={`menu md:flex md:relative fixed md:top-0 top-[82px] left-0 w-full bg-white md:gap-10 ${show?'block':'hidden'}`}>
                <NavLink className={({isActive})=>`${isActive?'text-red-500':'text-black'}`} to= '/'><li  className='g text-center border md:border-0 md:p-0 p-3 text-lg '>Shop</li></NavLink>
                <NavLink className={({isActive})=>`${isActive?'text-red-500':'text-black'}`} to= '/mens'><li  className='g text-center border md:border-0 md:p-0 p-3 text-lg'>Men</li></NavLink>
                <NavLink className={({isActive})=>`${isActive?'text-red-500':'text-black'}`} to ='/womens'><li  className='g border text-center md:border-0 md:p-0 p-3 text-lg'>Women</li></NavLink>
                <NavLink className={({isActive})=>`${isActive?'text-red-500':'text-black'}`} to ='/kids'><li  className='g border md:border-0 text-center md:p-0 p-3 text-lg'>Kids</li></NavLink>
